...
// RouteCert describes a TLS certificate for one or more routes
type RouteCert struct {
	// ID is the unique ID of this RouteCert
...
type Route struct {
	...
	Certificate *RouteCert `json:"certificate,omitempty"`
